        ...
        <div className="intro">
          ...
          <ul className="social-icons light list-inline mb-0 mt-4">
            <li className="list-inline-item">
              <a href="https://www.instagram.com/usamaaltaf22" target="blank" aria-label="usamaaltaf insta">
                <i className="fab fa-instagram"></i>
              </a>
            </li>
            <li className="list-inline-item">
              <a href="https://twitter.com/usamaaltaf122" target="blank" title="usamaaltaf122 twitter">
                <i className="fab fa-twitter"></i>
              </a>
            </li>
            <li className="list-inline-item">
              <a href="https://www.linkedin.com/in/usama-altaf-2475211ab/" target="blank">
